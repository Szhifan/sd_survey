...
all_targets = {
    ...
    "Migrants":{"fg_targets":["no fine-grained target","illegal migrants","refugees","asylum seekers","economic migrants",],"help":None},
    "European Union Institutions":{"fg_targets":["no fine-grained target","European Parliament","European Conmission", "European Council","FRONTEX","ECHO"],"help":"FRONTEX:European Border and Coast Guard Agency;ECHO:European Civil Protection and Humanitarian Aid Operations"},
    "refugee pathways":{"fg_targets":["no fine-grained target","boat sinking","mediterranean crossing","smuggling"],"help":"This includes phenomena occurring during the refugee's journey."},
    "refugee camps":{"fg_targets":["no fine-grained target","living conditions"],"help":"camps to accomondate refugees"},
    "asylum procedures":{"fg_targets":["no fine-grained target","protection", "compensation", "refugee status", "legal rights"],"help":"This includes legal procedures and concepts related to asylum application."},   
}
...
class SDSurvey: 
        ...
        for t in targets:
            with st.container(border=True):
                ...
                with l_col: 
                    ...
                    t_selected = self.survey.radio("please choose a fine-grained target (if applicable)", options=["No selection"] + all_targets[t]["fg_targets"], horizontal=True,id = f"t_{t}_{cur_idx}")
    ...
    def annotation_page(self,n:int):
        ...
        if cur_idx and not st.session_state["annos_completed"][cur_idx-1]:
            st.error("You haven't completed the last annotation")
