...
\n2: If the targets are relevant/somehow relevant, you should annotate the stance of the post towards the targets. The available stances are: :red[{positive, negative, neutral}]. Neutral is selected when the post does not take a clear stance towards the target, e.g. news report. 
